            ...
            <tbody>
              <?php
                foreach($list as $z)
                {
                  ...
                  echo '<td style="text-align: center">'.$z['tarjetentidad'].'</td>';
...
$(document).ready(function(event) {
  ...
  $(".fa-pencil").click(function (e) { 
    ...
    var id_tarj = $(this).parent('td').parent('tr').attr('id');
    console.log("ID de tarjeta");
    console.log(id_tarj);
    ed=id_tarj;
    $.ajax({
        type: 'GET',
        data: { id_tarj:id_tarj},
        url: 'index.php/Tarjeta/getpencil', //index.php/
        success: function(data){
                console.log("Estoy editando");           
                console.log(data);
               console.log(data[0]['tarjetentidad']);
               
                datos={
             
                  'codigoedit':data[0]['tarjetentidad'],
                  'nombreedit':data[0]['tarjetdescrip']
  ...
  $(".fa-times-circle").click(function (e) { 
    ...
    $.ajax({
            type: 'POST',
            data: { idtar: idtar},
            url: 'index.php/Tarjeta/baja_tarjet', //index.php/
            success: function(data){
                    //var data = jQuery.parseJSON( data );
                    console.log(data);
                   
                    //$(tr).remove();
                    alert("TARJETA Eliminado");
                    regresa();
...
function completarEdit(datos){
  ...
  $('#codigoedit').val(datos['codigoedit']);
  $('#nombreedit').val(datos['nombreedit']);
...
function guardareditar(){
  ...
  var nom = $('#nombreedit').val();
  var cod = $('#codigoedit').val();
  ...
  if( parametros !=0){                                     
    $.ajax({
      type:"POST",
      url: "index.php/Tarjeta/edit_tarjeta", //controlador /metodo
  ...
  { 
    alert("Por favor complete la informacion, es un campo obligatorio");
  }
...
function guardar(){
  ...
  var parametros = {
    'tarjetdescrip': nombre,
    'tarjetentidad': codigo,
  ...
  if( parametros !="")
    ...
    $.ajax({
      ...
      url: "index.php/Tarjeta/agregar_tarjeta", //controlador /metodo
...
function regresa(){
  ...
  //$('#modaleditar').empty(); 
  //$('#content').empty();
  $("#content").load("<?php echo base_url(); ?>index.php/Tarjeta/index/<?php echo $permission; ?>");
   WaitingClose();
}
  ...
  <div class="modal-dialog modal-lg" role="document" style="width: 50%">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title"  id="myModalLabel"><span id="modalAction" class="fa fa-plus-square" style="color: #008000" > </span>  Agregar Tarjeta</h4>
       </div> <!-- /.modal-header  -->
        ...
        <div class="row" >
          <div class="col-sm-12 col-md-12">
            ...
            <div class="col-xs-12">Nombre:
              <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Ingrese Nombre de Tarjeta...">
            </div>
         

            <div class="col-xs-12">Codigo:
    ...
    <div class="modal-content">
      ...
      <div class="modal-body input-group ui-widget" id="modalBodyArticle">
        ...
        <div class="row" >
          <div class="col-sm-12 col-md-12">
        <div class="col-xs-12">Nombre:
              <input type="text" id="nombreedit" name="nombreedit" class="form-control" placeholder="Ingrese Nombre de Tarjeta...">
              </div>

              <div class="col-xs-12">Codigo:
              <input type="text" id="codigoedit" name="codigoedit" class="form-control" placeholder="Ingrese Codigo...">
            </div> 
