            ...
            <tbody>
              <?php
                foreach($list as $z)
                {
                  ...
                  echo '<td style="text-align: center">'.$z['bancdir'].'</td>';
                  echo '<td style="text-align: center">'.$z['banccontacto'].'</td>';
                  
                  echo '<td style="text-align: center">'.$z['bancsucursal'].'</td>';
  ...
  <div class="modal-dialog modal-lg" role="document" style="width: 60%">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title"  id="myModalLabel"><span id="modalAction" class="fa fa-plus-square" style="color: #008000" > </span>  Agregar Banco</h4>
       </div> <!-- /.modal-header  -->
        ...
        <div class="row" >
          <div class="col-sm-12 col-md-12">
            <div class="col-xs-12">Descripcion:
              <input type="text" id="descripcion" name="descripcion" class="form-control" placeholder="Ingrese Nombre de Banco...">
              </div>
            ...
            <div class="col-xs-12">Sucursal:
              <input type="text" id="sucursal" name="sucursal" class="form-control" placeholder="Ingrese Sucursal...">
            </div> 
            </div>                   
          </div>
